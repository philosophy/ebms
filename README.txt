...
1. Open Git BASH
2. Go to ebms folder and update type the command "git pull"

/* To check if you have uncommited file changes */
1. git status

/* To commit your changes */
1. git add . or git add <filename>
2. gitk - to check your changes
