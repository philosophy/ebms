...
class Unit_model extends CI_Model {
    ...
    function getUnits() {
        $sql = "SELECT * FROM units where active=? and company_id=?";
    ...
    function createUnit() {
        ...
        $this->db->trans_start();
        $sql = "INSERT INTO units (name, created_by, date_created, company_id) values (?, ?, ?, ?)";
        $this->db->query($sql,
            array(
                $this->get_name(),
                $this->get_created_by(),
        ...
        $sql = 'SELECT id from units where company_id = ? order by date_created desc limit 1';
    ...
    function deactivateUnit() {
        ...
        /* insert audit DELETE */
        parent::insertAuditTrail($this->get_created_by(), 3, $this->get_id(), lang('deactivate_unit'), $this->get_company_id(), $this->table_name);
    ...
    function updateUnit() {
        ...
        /* insert audit UPDATE */
        parent::insertAuditTrail($this->get_last_updated_by(), 2, $this->get_id(), lang('update_unit'), $this->get_company_id(), $this->table_name);
    ...
    function restoreUnit() {
        ...
        /* insert audit */
        parent::insertAuditTrail($this->get_last_updated_by(), 2, $this->get_id(), lang('restore_unit'), $this->get_company_id(), $this->table_name);
    ...
    function unitExists() {
        $sql = "SELECT * FROM units where name = ? and company_id = ?";
    ...
    function recordExists() {
        $sql = "SELECT * FROM units where id!=? and name=? and company_id=?";
