...
//            $this->brandObj = new $this->Brand_model();
        ...
        function index() {
            $data['title'] = $this->lang->line('product_asset_list');
...
//            $this->sub_categories = $this->Sub_category_model->getSubCategoriesByCategoryId();
              send_json_response(INFO_LOG, HTTP_OK, 'new product form', array('html' => $this->load->view('inventory/_new_item_form', '', true)));
        }
