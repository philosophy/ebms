...
<fieldset>
    ...
    <?php echo form_input(array('name' => 'date_of_birth', 'id' => 'date_of_birth', 'data-dateofbirth' => $user->date_of_birth, 'value' => $user->date_of_birth, 'data-datepicker-img-url' => image_asset_url('calendar.gif'))); ?>
</fieldset>
