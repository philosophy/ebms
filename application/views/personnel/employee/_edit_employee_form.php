<section>
    ...
    <div id="edit-general" class="general">
        ...
        ?>
        <?php $this->load->view('personnel/employee/_edit_general_info'); ?>
        <?php echo form_close(); ?>
    </div>
    <div id="edit-employment-info" class="employment-info">
        <?php $this->load->view('personnel/employee/_edit_employment_info'); ?>
    </div>
    <div id="edit-educational-background" class="educational-background">
        <?php $this->load->view('personnel/employee/_edit_educational_background'); ?>
    </div>
    <div id="edit-payroll" class="payroll">
        <?php $this->load->view('personnel/employee/_edit_payroll'); ?>
    </div>
</section>