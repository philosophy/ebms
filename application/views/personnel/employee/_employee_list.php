    ...
    <table id="item-actions-list" class="table-list">
        ...
        <tbody>
            <?php if (isset($this->employees) && !empty($this->employees) && $employees_len > 0) { ?>
                ...
                ?>
                    <tr data-employee-id ="<?php echo $emp->id; ?>" data-delete-url ="<?php echo $delete_url; ?>" data-restore-url =<?php echo $restore_url;?> class="<?php echo ($emp->active == true) ? 'active' : 'inactive' ?>">
