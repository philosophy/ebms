...
<fieldset>
    ...
    <?php echo form_input(array('name' => 'first_name', 'id' => 'first-name', 'placeholder' => lang('first_name'), 'value' => $employee->first_name)); ?>
</fieldset>
<fieldset>
    <label>Middle Name*:</label>
    <?php echo form_input(array('name' => 'middle_name', 'id' => 'middle-name', 'placeholder' => lang('middle_name'), 'value' => $employee->middle_name)); ?>
</fieldset>
<fieldset>
    <label>Last Name*:</label>
    <?php echo form_input(array('name' => 'last_name', 'id' => 'last-name', 'placeholder' => lang('last_name'), 'value' => $employee->last_name)); ?>
</fieldset>
<fieldset>
    <label>Address*:</label>
    <?php echo form_textarea(array('name' => 'address', 'id' => 'address', 'placeholder' => lang('address_name'), 'rows' => '5', 'value' => $employee->address)); ?>
</fieldset>
<fieldset>
    <label>Date of Birth*:</label>
    <?php echo form_input(array('name' => 'date_of_birth', 'id' => 'date-of-birth', 'placeholder' => lang('date_of_birth'), 'data-datepicker-img-url' => image_asset_url('calendar.gif'), 'value' => $employee->date_of_birth)); ?>
</fieldset>
<fieldset>
    <label>Gender:</label>
    <select name="gender">
